<template>
  <div class = "appointment bg-home">
      <h1 class="title">UPDATE<br>APPOINTMENT</h1>
      <div class="position">
  ...
  <form  @submit.prevent="handleSubmitForm" >
    <div class="formbold-mb-5">
      ...
      <input
        ...
        v-model="client.lastname" required
      />
    </div>
    <div class="formbold-mb-5">
      ...
      <input
        ...
        class="formbold-form-input"
        v-model="client.firstname" required
      />
    </div>
    <div class="formbold-mb-5">
    ...
    <div class="formbold-mb-5">
      <label for="place" class="formbold-form-label"> Destination </label>
    <select type="place"
        class="formbold-form-input"
        v-model="client.place" required>
    ...
    <div>
      <div class="formbold-mb-5">
      <button class="formbold-btn" v-on:click="handleUpdateForm">Book Appointment</button>
    </div>
    </div>
  </form>
</div>
